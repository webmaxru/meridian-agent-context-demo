---
argument-hint: 'Optional: scope to a specific skill or prompt, e.g. /skills/agent-package-manager
  or /prompts/version-bump-and-deploy.prompt.md'
description: Scan skills and saved prompts for version consistency, bump versions
  where needed, commit, push, and deploy skills if any were bumped. Detects both local-vs-remote
  drift and same-version content changes in git history.
---
